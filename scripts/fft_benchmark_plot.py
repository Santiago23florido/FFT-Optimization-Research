...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--algorithms",
        default="radix2_iterative,radix2_recursive,direct_dft",
...
def main() -> int:
    ...
    print(f"- {summary_csv}")
    print(f"- {raw_csv}")
    print(f"- {output_dir / 'mean_runtime_us.png'}")
    print(f"- {output_dir / 'p95_runtime_us.png'}")
    print(f"- {output_dir / 'time_per_sample_ns.png'}")
    print(f"- {output_dir / 'throughput_samples_per_s.png'}")
